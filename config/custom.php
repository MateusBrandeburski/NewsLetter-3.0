...
return [
  'custom' => [
    ...
    'myTheme' => 'dark', // Options[String]: theme-default(default), theme-bordered, theme-semi-dark
    'myStyle' => 'system mode', // Options[String]: light(default), dark & system mode
    ...
    'contentLayout' => 'container-fluid', // options[String]: 'compact', 'wide' (compact=container-xxl, wide=container-fluid)
